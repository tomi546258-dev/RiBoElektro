window.siteData = {
  company: {
    ...
    email: 'info@riboelektro.hu',
    area: 'Budapest és környéke',
    introStats: [
      'Gyors kapcsolatfelvétel',
      'Lakossági és üzleti munkák',
      'Villany + elektronika együtt'
    ],
    heroHighlights: [
      {
        title: 'Villanyszerelés',
        text: 'Új kiállások, felújítás, bővítés, hibakeresés.'
      },
      {
        title: 'Elektronikai feladatok',
        text: 'Javítás, bekötés, mérés, műszaki segítség.'
      },
      {
        title: 'Korszerű szemlélet',
        text: 'Modern, letisztult arculat és könnyen bővíthető oldal.'
      }
    ]
  },
